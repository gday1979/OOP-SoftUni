namespace FightingArena.Tests
{
    ...
    public class WarriorTests
    {
        ...
        => typeof(Warrior).GetFields(BindingFlags.Instance | BindingFlags.NonPublic).First(x => x.Name == fieldName);
        ...
        {
            int expectedDamage = 55;
            Warrior warrior = new Warrior("Kris", expectedDamage, 33);
        ...
        public void TestDamageSetterValidation(int damage)
        {
            Assert.Throws<ArgumentException>(() =>
            {
                Warrior warrior = new Warrior("Kris", damage, 55);
        ...
        {
            int expectedHP = 55;
            Warrior warrior = new Warrior("Kris", 33, expectedHP);
        ...
        public void TestHPSetterValidation(int hp)
        {
            Assert.Throws<ArgumentException>(() =>
            {
                Warrior warrior = new Warrior("Kris", 55, hp);
        ...
        {
            Warrior warriorA = new Warrior("Kris", 70, startHP);
        ...
        {
            Warrior warriorA = new Warrior("Kris", 45, 65);
        ...
        public void SucessAttackShouldKillEnemyIfMyDamageIsOverTheirHP(int attackerDamage, int defenderHp)
        {
            ...
            Assert.AreEqual(expectedDefenderHp, actualDefenderHp, "Attacking enemy with lower HP than attacker Damage should leave them with zero HP!");
        }
