namespace FightingArena.Tests
{
    ...
    public class ArenaTests
    {
        ...
        public void TestConstructorInitializesEmptyCollectionOfWarrior()
        {
            ...
            CollectionAssert.AreEqual(expectedCollection, actualCollection,"Arena constructor should initialize an empty collection for Warriors!");
        }
        ...
        {
            //Act
            Warrior warrior = new Warrior("Kris", 50, 100);
        ...
        {
            Warrior pesho = new Warrior("Kris", 30, 100);
            Warrior kris = new Warrior("Gosho", 35, 85);

            this.arena.Enroll(pesho);
            this.arena.Enroll(kris);
