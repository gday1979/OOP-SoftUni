...
namespace ValidationAttributes.Utilities
{
    ...
    public static class Validator
    {
        ...
        public static bool IsValid(object obj)
        {
            ...
            (pi => pi.CustomAttributes.Any
            (a => a.AttributeType.BaseType == typeof(MyValidationAttribute))).ToArray();
            ...
            foreach (PropertyInfo property in properties)
            {
                ...
                foreach (CustomAttributeData customAttributeData in property.CustomAttributes)
                {
                    ...
                    MethodInfo validationMethod = customAttrType.GetMethods().First(m => m.Name == "IsValid");
